...
// Set location
float lat=52.06561405;
float lon=4.49780490;
int   alt=1;

/* Informal status fields */
static char platform[24]    = "Single Channel Gateway";  /* platform definition */
static char email[40]       = "";                        /* used for contact email */
static char description[64] = "raspberry-pi3-lora-gps-hat";     /* used for free form description */

// define servers
// TODO: use host names and dns
#define SERVER1 "52.169.76.203"    // The Things Network
#define SERVER2 "127.0.0.1"      // local
